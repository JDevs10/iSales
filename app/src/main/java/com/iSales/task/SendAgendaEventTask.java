    ...
    protected Void doInBackground(Void... voids) {
        ...
        new SaveLogs(mContext).writeLogFile(
                new DebugItem(
                        ...
                        "DEB", SendAgendaEventTask.class.getSimpleName(),
                        "doInBackground()",
                    ...
                    try {
                        ...
                        new SaveLogs(mContext).writeLogFile(
                                new DebugItem(
                                        ...
                                        "DEB", SendAgendaEventTask.class.getSimpleName(),
                                        "doInBackground() => onResponse()",
                                        response.message() + " | code=" + response.code() + " | code=" + response.errorBody().string(),
                                        ""
                                )
                        );
